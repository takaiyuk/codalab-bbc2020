...
PROFILE = default
PROJECT_NAME = basketball-behavior-challenge
...
## Make Dataset
data: requirements
	$(PYTHON_INTERPRETER) src/data/make_dataset.py data/raw data/interim True
	$(PYTHON_INTERPRETER) src/data/make_dataset.py data/raw data/interim False
